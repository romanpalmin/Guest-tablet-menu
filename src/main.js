    ...
    mounted(){
        ...
        let showModal = setInterval(() => {
            ...
            let condition = this.$store.state.app.isShowModalAnketa && //признак показа модального окна
                ...
                this.$store.state.settings.showButtons && // признак того, что это не уличное меню
    ...
    <div class="header intro-header" >
        <nav v-if= "$store.state.settings.language === 'ru'" class="pages-nav">
           <!-- <div class="pages-nav__item" @click="showModal()">Modal</div>-->
            ...
            <div class="pages-nav__item "  v-if="$store.state.settings.showButtons"><router-link to="/ru/Actions3" class="link-page link">Анкета</router-link></div>
            ...
            <div class="pages-nav__item "  v-if="$store.state.settings.showButtons"><router-link to="/ru/order" class="link-page link">Вы заказали</router-link></div>
        </nav>
         <nav v-else class="pages-nav">
            ...
            <div class="pages-nav__item "  v-if="$store.state.settings.showButtons"><router-link to="/en/order" class="link-page link">Your order</router-link></div>
        </nav>
